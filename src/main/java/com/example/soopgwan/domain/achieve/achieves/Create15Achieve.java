...
public class Create15Achieve implements BaseAchieve {
    ...
    public Achieve getAchieveEntity() {
        return achieveRepository.findByCode(AchieveType.CREATE_15)
    ...
    public boolean isGoalSuccess() {
        ...
        return weekHabitRepository.countAllByUser(user) >= 15;
    }
}
