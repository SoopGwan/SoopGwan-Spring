...
public class Complete25Achieve  implements BaseAchieve {
    ...
    public Achieve getAchieveEntity() {
        return achieveRepository.findByCode(AchieveType.COMPLETE_25)
    ...
    public boolean isGoalSuccess() {
        ...
        return weekHabitRepository.sumSuccessCountAllByUser(user) >= 25;
    }
}
